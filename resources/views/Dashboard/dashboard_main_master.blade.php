...
<head>
	...
	<!-- FAVICONS ICON -->
	<link rel="shortcut icon" type="image/png" href="{{ asset(App\Models\SystemSetting::findorFail(1)->favicon) }}" />
	...
	***********************************-->
	<div id="main-wrapper">
		...
		***********************************-->
		<div class="footer">
			<div class="copyright">
				<p>Copyright © Designed &amp; Developed by <a href="https://dexignlab.com/" target="_blank">TaofeeTech</a> {{ Carbon\Carbon::now()->year }}</p>
			</div>
		</div>
		<!--**********************************
			Footer end
...
<!-- Mirrored from travl.dexignlab.com/xhtml/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 06 Aug 2024 22:20:03 GMT -->
</html>
