        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="tp-breadcrumb-title-wrap text-center">
                    <h2 class="tp-breadcrumb-title-blog tp-breadcrumb-title-blog-3 mb-15">Checkout</h2>
                    ...
                    <div id="checkout-login" class="coupon-content">
                        <div class="coupon-info">
                            ...
                            <form action="#">
                                ...
                                <p class="form-row">
                                    <button class="tp-cart-checkout-btn" type="submit">Login</button>
                                    <label>
                                        <input type="checkbox">
                                        Remember me
                                    </label>
                        ...
                        <div class="coupon-info">
                            <form action="#">
                                <p class="checkout-coupon">
                                    ...
                                    <button class="tp-cart-checkout-btn" type="submit">Apply Coupon</button>
                                </p>
                            </form>
                        </div>
                    </div>
...
<!-- checkout-area start -->
<section class="checkout-area pb-80">
    <div class="container">
        <form action="#">
            <div class="row">
                    ...
                    <div class="your-order mb-30 ">
                                ...
                                <tbody>
                                    <tr class="cart_item">
                                        <td class="product-name">
                                            Eko Clean <strong class="product-quantity"> × 1</strong>
                                        </td>
                                    ...
                                    <tr class="cart_item">
                                        <td class="product-name">
                                            Clean Orange <strong class="product-quantity"> × 1</strong>
                                        </td>
                                        <td class="product-total">
                                ...
                                <tfoot>
                                    ...
                                    <tr class="shipping">
                                        ...
                                        <td>
                                            <ul>
                                                <li>
                                                    <input id="radio1" type="radio" name="shipping">
                                                    <label for="radio1"> Flat Rate: <span
                                                            class="amount">$7.00</span></label>
                                                </li>
                                                <li>
                                                    <input id="radio2" type="radio" name="shipping">
                        ...
                        <div class="payment-method">
                            ...
                            <div class="order-button-payment mt-20">
                                <button type="submit" class="tp-cart-checkout-btn  w-100">Place order</button>
                            </div>
                        </div>
                    </div>
                </div>
