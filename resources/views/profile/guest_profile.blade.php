                                ...
                                <div class="col-xl-6 p-0">
                                    <div class="card-body">
                                        <div class="guest-profile">
                                            <div class="d-flex">
                                                <img src="{{ $guest->image ? asset($guest->image) : asset('uploads/no_image.png') }}"
                                                    alt="">
                                                <div>
                                                    <h2 class="font-w600">{{ $guest->name }}</h2>
                                                    <span class="text-secondary">ID: #{{ $guest->id }}</span>
                                                    <div class="call d-flex align-items-center">
                                                        <a href="javascript:void(0);"><i
                                                                class="fas fa-phone-alt text-secondary"></i></a>
                                            ...
                                            {{-- <div class="d-flex">
                                                <div class="mt-4 check-status">
                                                    ...
                                                    <span class="font-w500 fs-16">{{  Carbon\Carbon::create($guest_current_room->arrival_date)->format('F j, Y') }}</span>
                                                </div>
                                                <div class="mt-4">
                                                    <span class="d-block mb-2">Check Out</span>
                                                    <span class="font-w500 fs-16">{{ Carbon\Carbon::create($guest_current_room->departure_date)->format('F j, Y') }}</span>
                                                </div>
                                            </div> --}}
                                        </div>
                                        {{-- <div class="d-flex flex-wrap">
                                            <div class="mt-4 check-status">
                                                ...
                                                <h4 class="font-w500 fs-24">{{ $guest_current_room->room->category->cat_name . '-' . $guest_current_room->room->room_number }}</h4>
                                            </div>
                                            <div class="mt-4 ms-3">
                                                <span class="d-block mb-2 text-black">Price</span>
                                                <span class="font-w500 fs-24 text-black">{{ $guest_current_room->rate }}<small
                                            ...
                                            <div class="mb-3 ">
                                                ...
                                                <a href="javascript:void(0);" class="btn btn-secondary light btn-lg">
                                                    <svg class="me-2" xmlns="http://www.w3.org/2000/svg" width="20"
                                                        height="23.512" viewBox="0 0 20 23.512">
                                                ...
                                                <a href="javascript:void(0);" class="btn btn-secondary light btn-lg">
                                                    <svg class="me-2" xmlns="http://www.w3.org/2000/svg" width="20"
                                                        height="15.75" viewBox="0 0 20 15.75">
                                                        <g id="internet" transform="translate(0 -2.15)">
                                                            ...
                                                            <circle id="Ellipse_10" data-name="Ellipse 10" cx="1.9"
                                                                cy="1.9" r="1.9" transform="translate(8.2 14.1)"
                                                                fill="#135846" />
                                                        </g>
                                                    </svg>
                                                    Free Wifi</a>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-xl-2 col-sm-4 col-6">
                                        <div class="mt-sm-0 mt-3">
                                            <span class="d-block mb-2 text-black">Price</span>
                                            <span class="font-w500 fs-24 text-black">$145<small
                                                    class="fs-14 ms-2 text-secondary">/night</small></span>
                                        </div>
                                    </div>
                                    <div class="col-xl-2 col-sm-4 col-6">
